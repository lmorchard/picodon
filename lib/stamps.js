...
const ActorId = ({ baseUrl, username }) =>
  `${baseUrl}/@${username}`;
...
const ObjectNote = ({ id, url, to, cc, published, attributedTo, content, ...props }) =>
  BaseObject({
    type: "Note",
    ...
    attributedTo,
    to, // : ["https://www.w3.org/ns/activitystreams#Public"],
    cc, // : [ "https://toot.cafe/users/lmorchard/followers", "https://sunset-screen.glitch.me/@botbot"],
    content
  });
